...
class CatalogoModel extends FlutterFlowModel<CatalogoWidget> {
  ...
  PagingController<DocumentSnapshot?, ProductosRecord> setListViewController1(
    Query query, {
  ...
  PagingController<DocumentSnapshot?, ProductosRecord> setListViewController2(
    Query query, {
    DocumentReference<Object?>? parent,
  }) {
  ...
  PagingController<DocumentSnapshot?, ProductosRecord> setListViewController3(
    Query query, {
    DocumentReference<Object?>? parent,
  }) {
